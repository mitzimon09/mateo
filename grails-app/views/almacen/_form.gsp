...
<div class="fieldcontain ${hasErrors(bean: almacenInstance, field: 'nombreCompleto', 'error')} ">
	<label for="nombreCompleto">
		<g:message code="almacen.nombreCompleto.label" default="Nombre Completo" />
		
	</label>
	<g:textField name="nombreCompleto" value="${almacenInstance?.nombreCompleto}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: almacenInstance, field: 'tiposProducto', 'error')} ">
	...
	<g:select name="tiposProducto" from="${inventario.TipoProducto.list()}" multiple="multiple" optionKey="id" size="5" value="${almacenInstance?.tiposProducto*.id}" class="many-to-many"/>
</div>
