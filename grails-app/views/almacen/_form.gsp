...
<div class="fieldcontain ${hasErrors(bean: almacen, field: 'nombreCompleto', 'error')} ">
	<label for="nombreCompleto">
		<g:message code="almacen.nombreCompleto.label" default="Nombre Completo" />
		
	</label>
	<g:textField name="nombreCompleto" value="${almacen?.nombreCompleto}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: almacen, field: 'tiposProducto', 'error')} ">
	...
	<g:select name="tiposProducto" from="${inventario.TipoProducto.list()}" multiple="multiple" optionKey="id" size="5" value="${almacen?.tiposProducto*.id}" class="many-to-many"/>
</div>
