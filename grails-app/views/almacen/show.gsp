			...
			<ol class="property-list almacen">
				...
				<li class="fieldcontain">
					<span id="empresa-label" class="property-label"><g:message code="almacen.empresa.label" default="Empresa" /></span>
						...
						<span class="property-value" aria-labelledby="empresa-label"><g:link controller="empresa" action="ver" id="${almacen?.empresa?.id}">${almacen?.empresa?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="entradas-label" class="property-label"><g:message code="almacen.entradas.label" default="Entradas" /></span>
						...
						<span class="property-value" aria-labelledby="entradas-label"><g:link controller="entrada" action="ver" id="${e.id}">${e?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="facturas-label" class="property-label"><g:message code="almacen.facturas.label" default="Facturas" /></span>
						...
						<span class="property-value" aria-labelledby="facturas-label"><g:link controller="facturaAlmacen" action="ver" id="${f.id}">${f?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="folios-label" class="property-label"><g:message code="almacen.folios.label" default="Folios" /></span>
						...
						<span class="property-value" aria-labelledby="folios-label"><g:link controller="folioInventario" action="ver" id="${f.id}">${f?.encodeAsHTML()}</g:link></span>
						</g:each>
					
				</li>
				</g:if>
			
				<g:if test="${almacen?.nombreCompleto}">
				<li class="fieldcontain">
					<span id="nombreCompleto-label" class="property-label"><g:message code="almacen.nombreCompleto.label" default="Nombre Completo" /></span>
					
						<span class="property-value" aria-labelledby="nombreCompleto-label"><g:fieldValue bean="${almacen}" field="nombreCompleto"/></span>
				...
				<li class="fieldcontain">
					<span id="productos-label" class="property-label"><g:message code="almacen.productos.label" default="Productos" /></span>
						...
						<span class="property-value" aria-labelledby="productos-label"><g:link controller="producto" action="ver" id="${p.id}">${p?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="salidas-label" class="property-label"><g:message code="almacen.salidas.label" default="Salidas" /></span>
						...
						<span class="property-value" aria-labelledby="salidas-label"><g:link controller="salida" action="ver" id="${s.id}">${s?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="tiposProducto-label" class="property-label"><g:message code="almacen.tiposProducto.label" default="Tipos Producto" /></span>
						...
						<span class="property-value" aria-labelledby="tiposProducto-label"><g:link controller="tipoProducto" action="ver" id="${t.id}">${t?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="usuarios-label" class="property-label"><g:message code="almacen.usuarios.label" default="Usuarios" /></span>
						...
						<span class="property-value" aria-labelledby="usuarios-label"><g:link controller="usuario" action="ver" id="${u.id}">${u?.encodeAsHTML()}</g:link></span>
						</g:each>
