	...
	<body>
		...
		<div id="show-almacen" class="content scaffold-show" role="main">
			...
			<ol class="property-list almacen">
				...
				<g:if test="${almacenInstance?.nombreCompleto}">
				<li class="fieldcontain">
					<span id="nombreCompleto-label" class="property-label"><g:message code="almacen.nombreCompleto.label" default="Nombre Completo" /></span>
						...
						<span class="property-value" aria-labelledby="nombreCompleto-label"><g:fieldValue bean="${almacenInstance}" field="nombreCompleto"/></span>
