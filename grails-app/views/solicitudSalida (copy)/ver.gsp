	...
	<body>
		...
		<div id="show-solicitudSalida" class="content scaffold-show" role="main">
			...
			<ol class="property-list solicitudSalida">
				...
				<li class="fieldcontain">
					<span id="observacionesRh-label" class="property-label"><g:message code="solicitudSalida.observacionesRh.label" default="ObservacionesRh" /></span>
				...
				<li class="fieldcontain">
					<span id="folio-label" class="property-label"><g:message code="solicitudSalida.folio.label" default="Folio" /></span>
						...
						<span class="property-value" aria-labelledby="folio-label"><g:link controller="vacaciones" action="ver" id="${solicitudSalida?.vacaciones?.id}">${solicitudSalida?.vacaciones?.encodeAsHTML()}</g:link></span>
