			...
			<ol class="property-list proveedor">
				...
				<li class="fieldcontain">
					<span id="empresa-label" class="property-label"><g:message code="proveedor.empresa.label" default="Empresa" /></span>
						...
						<span class="property-value" aria-labelledby="empresa-label"><g:link controller="empresa" action="ver" id="${proveedor?.empresa?.id}">${proveedor?.empresa?.encodeAsHTML()}</g:link></span>
