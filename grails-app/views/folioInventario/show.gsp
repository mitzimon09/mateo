	...
	<body>
		...
		<div id="show-folioInventario" class="content scaffold-show" role="main">
			...
			<ol class="property-list folioInventario">
				...
				<g:if test="${folioInventario?.nombre}">
				<li class="fieldcontain">
					<span id="nombre-label" class="property-label"><g:message code="folioInventario.nombre.label" default="Nombre" /></span>
					
						<span class="property-value" aria-labelledby="nombre-label"><g:fieldValue bean="${folioInventario}" field="nombre"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${folioInventario?.valor}">
				<li class="fieldcontain">
					<span id="valor-label" class="property-label"><g:message code="folioInventario.valor.label" default="Valor" /></span>
					
						<span class="property-value" aria-labelledby="valor-label"><g:fieldValue bean="${folioInventario}" field="valor"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${folioInventario?.almacen}">
				<li class="fieldcontain">
					<span id="almacen-label" class="property-label"><g:message code="folioInventario.almacen.label" default="Almacen" /></span>
					
						<span class="property-value" aria-labelledby="almacen-label"><g:link controller="almacen" action="ver" id="${folioInventario?.almacen?.id}">${folioInventario?.almacen?.encodeAsHTML()}</g:link></span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${folioInventario?.id}" />
					<g:link class="edit" action="edita" id="${folioInventario?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
