...
<html>
	...
	<body>
		<a href="#edit-empleadoPuesto" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-empleadoPuesto" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${empleadoPuesto?.version}" />
				<fieldset class="form">
