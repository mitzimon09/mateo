			...
			<ol class="property-list producto">
				...
				<li class="fieldcontain">
					<span id="tipoProducto-label" class="property-label"><g:message code="producto.tipoProducto.label" default="Tipo Producto" /></span>
						...
						<span class="property-value" aria-labelledby="tipoProducto-label"><g:link controller="tipoProducto" action="ver" id="${producto?.tipoProducto?.id}">${producto?.tipoProducto?.encodeAsHTML()}</g:link></span>
