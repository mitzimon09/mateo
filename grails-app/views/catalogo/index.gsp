    ...
    <body>
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" controller="tipoEmpleado"><g:message code="tipoEmpleado.list.label" default="Tipo Empleado" /></g:link></li>
                <li><g:link class="list" controller="tipoDependiente"><g:message code="tipoDependiente.list.label" default="Tipo Dependiente" /></g:link></li>
                <li><g:link class="list" controller="diasFeriados"><g:message code="diasFeriados.list.label" default="Días Feriados" /></g:link></li>
                <li><g:link class="list" controller="nivelEstudios"><g:message code="nivelEstudios.list.label" default="Nivel de Estudios" /></g:link></li>
			</ul>
		</div>
        <div class="content">
