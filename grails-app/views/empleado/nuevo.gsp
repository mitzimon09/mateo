...
<div class="fieldcontain ${hasErrors(bean: empleado, field: 'tipo', 'error')} required"">
	<label for="tipo">
...
<div class="fieldcontain ${hasErrors(bean: empleado, field: 'telefonoCasa', 'error')} ">
	<label for="telefonoCasa">
		<g:message code="empleado.telefonoCasa.label" default="Telefono Casa" />
		
	</label>
	<g:textField name="telefonoCasa" value="${empleado?.telefonoCasa}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: empleado, field: 'telefonocelular', 'error')} ">
	<label for="telefonocelular">
		<g:message code="empleado.telefonocelular.label" default="Telefonocelular" />
		
	</label>
	<g:textField name="telefonocelular" value="${empleado?.telefonocelular}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: empleado, field: 'email', 'error')} ">
	<label for="email">
		<g:message code="empleado.email.label" default="Email" />
		
	</label>
	<g:textField name="email" value="${empleado?.email}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: empleado, field: 'estudiosList', 'error')} ">
	<label for="estudiosList">
		<g:message code="empleado.estudiosList.label" default="Estudios List" />
		
	</label>
	
<ul class="one-to-many">
<g:each in="${empleado?.estudiosList?}" var="e">
    <li><g:link controller="empleadoEstudios" action="show" id="${e.id}">${e?.encodeAsHTML()}</g:link></li>
</g:each>
<li class="add">
<g:link controller="empleadoEstudios" action="create" params="['empleado.id': empleado?.id]">${message(code: 'default.add.label', args: [message(code: 'empleadoEstudios.label', default: 'EmpleadoEstudios')])}</g:link>
</li>
</ul>
