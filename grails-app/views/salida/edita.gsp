...
<html>
	...
	<body>
		<a href="#edit-salida" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-salida" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${salidaInstance?.version}" />
				<fieldset class="form">
