...
<div class="fieldcontain ${hasErrors(bean: salidaInstance, field: 'facturada', 'error')} ">
	<label for="facturada">
		<g:message code="salida.facturada.label" default="Facturada" />
		
	</label>
	<g:checkBox name="facturada" value="${salidaInstance?.facturada}" />
</div>
