			...
			<ol class="property-list loteEntrada">
				...
				<li class="fieldcontain">
					<span id="entrada-label" class="property-label"><g:message code="loteEntrada.entrada.label" default="Entrada" /></span>
						...
						<span class="property-value" aria-labelledby="entrada-label"><g:link controller="entrada" action="ver" id="${loteEntrada?.entrada?.id}">${loteEntrada?.entrada?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="producto-label" class="property-label"><g:message code="loteEntrada.producto.label" default="Producto" /></span>
						...
						<span class="property-value" aria-labelledby="producto-label"><g:link controller="producto" action="ver" id="${loteEntrada?.producto?.id}">${loteEntrada?.producto?.encodeAsHTML()}</g:link></span>
