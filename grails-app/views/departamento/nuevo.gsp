...
<html>
	...
	<body>
		...
		<div id="create-departamento" class="content scaffold-create" role="main">
			...
			<g:hasErrors bean="${departamento}">
			<ul class="errors" role="alert">
				<g:eachError bean="${departamento}" var="error">
			...
			<g:form action="crea" >
				...
				<fieldset class="buttons">
					<g:submitButton name="create" class="crea" value="${message(code: 'default.button.create.label', default: 'Create')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
