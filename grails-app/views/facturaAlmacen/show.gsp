			...
			<ol class="property-list facturaAlmacen">
				...
				<li class="fieldcontain">
					<span id="almacen-label" class="property-label"><g:message code="facturaAlmacen.almacen.label" default="Almacen" /></span>
						...
						<span class="property-value" aria-labelledby="almacen-label"><g:link controller="almacen" action="ver" id="${facturaAlmacen?.almacen?.id}">${facturaAlmacen?.almacen?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="cliente-label" class="property-label"><g:message code="facturaAlmacen.cliente.label" default="Cliente" /></span>
						...
						<span class="property-value" aria-labelledby="cliente-label"><g:link controller="cliente" action="ver" id="${facturaAlmacen?.cliente?.id}">${facturaAlmacen?.cliente?.encodeAsHTML()}</g:link></span>
