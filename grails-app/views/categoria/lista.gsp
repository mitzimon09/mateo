	...
	<body>
		...
		<div id="list-categoria" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
    					<g:sortableColumn property="numero" title="${message(code: 'categoria.numero.label', default: 'Numero')}" />
				...
				<g:each in="${categorias}" status="i" var="categoria">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="ver" id="${categoria.id}">${fieldValue(bean: categoria, field: "id")}</g:link></td>
					    <td>${fieldValue(bean: categoria, field: "nombre")}</td>
			...
			<div class="pagination">
				<g:paginate total="${totalDeCategorias}" />
			</div>
		</div>
	</body>
</html>
